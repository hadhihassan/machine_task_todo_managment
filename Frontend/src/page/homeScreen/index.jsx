    ...
    return (
        <main className="h-[200vh] ">
            <div className="w-full flex items-end justify-end">
                <button className="py-2 px-4 bg-violet-600 hover:bg-violet-700 text-white font-semibold rounded-lg shadow-lg ">New Project</button>
            </div>
            <div className="w-full my-9 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 py-5">
                <div className="border p-5 rounded-lg border-violet-900 hover:border-violet-500  max-w-[300px] max-h-[100p] transition-all duration-700 hover:scale-110">
